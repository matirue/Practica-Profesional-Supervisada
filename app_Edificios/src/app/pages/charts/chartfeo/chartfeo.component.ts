...
@Component({
  selector: 'app-chartfeo',
  templateUrl: './chartfeo.component.html',
  styleUrls: ['./chartfeo.component.scss'],
})

export class ChartfeoComponent implements OnInit {
  options:any;
  fotos: any;
  datos: any;
  image: string = '';
  ...
  ionViewWillEnter(){
    ...
    console.log('datos: ', arrayDatos, 'contador: ', this.contador);
  }
